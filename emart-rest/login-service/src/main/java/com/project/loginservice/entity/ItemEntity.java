...
//	int  sellerId;
	...
	public ItemEntity(Integer id, String name, SubCategoryEntity subCategoryId, int price, String description,
			int stock, String remarks, String image, SellerSignupEntity sellerId) {
		super();
		this.id = id;
		this.name = name;
		this.subCategoryId = subCategoryId;
	...
	public String toString() {
		return "ItemEntity [id=" + id + ", name=" + name + ", subCategoryId=" + subCategoryId + ", price=" + price
